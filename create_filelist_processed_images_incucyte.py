...
for groupname, groupentries in df_imagings.groupby("experiment ID"):
    ...
    df_output_one_experiment.to_csv(  f"./filelists_incucyte/filelist_incucyte_processed_images_experiment_id_{groupname}.csv",  index=False)
    df_output_one_experiment.to_excel(f"./filelists_incucyte/filelist_incucyte_processed_images_experiment_id_{groupname}.xlsx", index=False)


df_output_all_experiments = pandas.concat(df_collector_all)

print("writing the big filelist...")
df_output_all_experiments.to_csv(  f"./filelists_incucyte/filelist_incucyte_processed_images_all_experiments.csv",  index=False)
df_output_all_experiments.to_excel(f"./filelists_incucyte/filelist_incucyte_processed_images_all_experiments.xlsx", index=False)
